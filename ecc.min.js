...
a:try{var D;if("undefined"!==typeof window&&"undefined"!==typeof Uint32Array){D=new Uint32Array(32);if(window.crypto&&window.crypto.getRandomValues)window.crypto.getRandomValues(D);else if(window.msCrypto&&window.msCrypto.getRandomValues)window.msCrypto.getRandomValues(D);else break a;sjcl.random.addEntropy(D,1024,"crypto['getRandomValues']")}else{for(var E=[],F=0;32>F;F++)E.push((new Date).valueOf()*(1E3*Math.random()|0));sjcl.random.addEntropy(E,1024,"loadtime")}}catch(a){"undefined"!==typeof window&&
window.console&&(console.log("There was an error collecting entropy from the browser:"),console.log(a))}
...
sjcl.ecc.ecdsa.secretKey.prototype={sign:function(a,b,c,d){sjcl.bitArray.bitLength(a)>this.s&&(a=sjcl.bitArray.clamp(a,this.s));var e=this.i.r,f=e.bitLength();d=d||sjcl.bn.random(e.sub(1),b).add(1);b=this.i.G.mult(d).x.mod(e);a=sjcl.bn.fromBits(a).add(b.mul(this.H));c=c?a.inverseMod(e).mul(d).mod(e):a.mul(d.inverseMod(e)).mod(e);return sjcl.bitArray.concat(b.toBits(f),c.toBits(f))},getType:function(){return"ecdsa"}};var H={},I=H.ENC_DEC={},J=H.SIG_VER={},L=K("elGamal"),M=K("ecdsa"),O=N();H.sjcl=sjcl;
H.generate=function(a,b){b||(b=192);var c,d,e;if(a===I)d="enc",e="dec",c=L.generate(b);else if(a===J)d="ver",e="sig",c=M.generate(b);else throw"eccjs: generate: Unknown type";var f={},g;g=c.pub;var h=g.get();g=g.M+sjcl.codec.hex.fromBits(h.x)+sjcl.codec.hex.fromBits(h.y);f[d]=g;c=c.sec;c=c.M+sjcl.codec.hex.fromBits(c.get());f[e]=c;return f};var P={enc:{},dec:{},sig:{},ver:{}};
H.encrypt=function(a,b){try{var c=P.enc[a];c||(c=P.enc[a]=L.importPublic(a).kem(),c.tagHex=sjcl.codec.hex.fromBits(c.tag));var d=sjcl.json.ea(c.key,b);d.tag=c.tagHex;for(var e in d)d[e]&&(d[e].toJSON=null);return JSON.stringify(d)}catch(f){return"undefined"!==typeof console&&console.error&&console.error(f),b}};
H.decrypt=function(a,b){var c=JSON.parse(b);try{var d=P.dec[a];d||(d=P.dec[a]=L.importSecret(a),d.Y={});var e=d.Y[c.tag];e||(e=d.Y[c.tag]=d.unkem(sjcl.codec.hex.toBits(c.tag)));return sjcl.json.da(e,c)}catch(f){return"undefined"!==typeof console&&console.error&&console.error(f),b}};H.sign=function(a,b,c){var d=P.sig[a];d||(d=P.sig[a]=M.importSecret(a));!1!==c&&(b=O.hash(b));return d.sign(b)};
H.verify=function(a,b,c,d){var e=P.ver[a];e||(e=P.ver[a]=M.importPublic(a));!1!==d&&(c=O.hash(c));try{return e.verify(c,b)}catch(f){return!1}};function K(a){var b=sjcl.ecc[a];if(!b)throw Error("Missing ECC algorithm: "+a);return{generate:function(a){var d=b.generateKeys(a,1);d.pub.M=a;d.sec.M=a;return d},importPublic:function(a){a=Q(a);return new b.publicKey(a.curve,sjcl.codec.hex.toBits(a.hex))},importSecret:function(a){a=Q(a);return new b.secretKey(a.curve,new sjcl.bn(a.hex))}}}
function Q(a){return{curve:sjcl.ecc.curves["c"+a.substr(0,3)],hex:a.substr(3)}}function N(){var a=sjcl.hash.sha256;if(!a)throw Error("Missing hash algorithm: sha256");return{hash:function(b){return a.hash(b)}}}"undefined"!==typeof module&&module.exports?module.exports=H:"undefined"!==typeof window?window.ecc=H:this.ecc=H;
