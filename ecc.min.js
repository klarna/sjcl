...
var J={},K=J.ENC_DEC={},L=J.SIG_VER={},N=M("elGamal"),O=M("ecdsa"),Q=P();J.sjcl=sjcl;J.generate=function(a,b){b||(b=192);var c,d,e;if(a===K)d="enc",e="dec",c=N.generate(b);else if(a===L)d="ver",e="sig",c=O.generate(b);else throw"eccjs: generate: Unknown type";var f={},g;g=c.pub;var h=g.get();g=g.M+sjcl.codec.hex.fromBits(h.x)+sjcl.codec.hex.fromBits(h.y);f[d]=g;c=c.sec;c=c.M+sjcl.codec.hex.fromBits(c.get());f[e]=c;return f};var R={enc:{},dec:{},sig:{},ver:{}};
J.encrypt=function(a,b){var c=R.enc[a];c||(c=R.enc[a]=N.importPublic(a).kem(),c.tagHex=sjcl.codec.hex.fromBits(c.tag));var d=sjcl.json.ea(c.key,b);d.tag=c.tagHex;return JSON.stringify(d)};J.decrypt=function(a,b){var c=JSON.parse(b),d=R.dec[a];d||(d=R.dec[a]=N.importSecret(a),d.Y={});var e=d.Y[c.tag];e||(e=d.Y[c.tag]=d.unkem(sjcl.codec.hex.toBits(c.tag)));return sjcl.json.da(e,c)};J.sign=function(a,b,c){var d=R.sig[a];d||(d=R.sig[a]=O.importSecret(a));!1!==c&&(b=Q.hash(b));return d.sign(b)};
J.verify=function(a,b,c,d){var e=R.ver[a];e||(e=R.ver[a]=O.importPublic(a));!1!==d&&(c=Q.hash(c));try{return e.verify(c,b)}catch(f){return!1}};function M(a){var b=sjcl.ecc[a];if(!b)throw Error("Missing ECC algorithm: "+a);return{generate:function(a){var d=b.generateKeys(a,1);d.pub.M=a;d.sec.M=a;return d},importPublic:function(a){a=S(a);return new b.publicKey(a.curve,sjcl.codec.hex.toBits(a.hex))},importSecret:function(a){a=S(a);return new b.secretKey(a.curve,new sjcl.bn(a.hex))}}}
function S(a){return{curve:sjcl.ecc.curves["c"+a.substr(0,3)],hex:a.substr(3)}}function P(){var a=sjcl.hash.sha256;if(!a)throw Error("Missing hash algorithm: sha256");return{hash:function(b){return a.hash(b)}}}"undefined"!==typeof module&&module.exports?module.exports=J:window.ecc=J;
