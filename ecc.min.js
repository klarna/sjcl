...
H.encrypt=function(a,b){try{var c=P.enc[a];c||(c=P.enc[a]=L.importPublic(a).kem(),c.tagHex=sjcl.codec.hex.fromBits(c.tag));var d=sjcl.json.ea(c.key,b);d.tag=c.tagHex;return JSON.stringify(d)}catch(e){return"undefined"!==typeof console&&console.error&&console.error(e),b}};
