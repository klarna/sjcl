...
sjcl.cipher.aes=function(a){this.B[0][0][0]||this.U();var b,c,d,e,f=this.B[0][4],g=this.B[1];b=a.length;var h=1;if(4!==b&&6!==b&&8!==b)throw new sjcl.exception.invalid("invalid aes key size");this.g=[d=a.slice(0),e=[]];for(a=b;a<4*b+28;a++){c=d[a-1];if(0===a%b||8===b&&4===a%b)c=f[c>>>24]<<24^f[c>>16&255]<<16^f[c>>8&255]<<8^f[c&255],0===a%b&&(c=c<<8^c>>>24^h<<24,h=h<<1^283*(h>>7));d[a]=d[a-b]^c}for(b=0;a;b++,a--)c=d[b&3?a:a-4],e[b]=4>=a||4>b?c:g[0][f[c>>>24]]^g[1][f[c>>16&255]]^g[2][f[c>>8&255]]^g[3][f[c&
255]]};
sjcl.cipher.aes.prototype={encrypt:function(a){return t(this,a,0)},decrypt:function(a){return t(this,a,1)},B:[[[],[],[],[],[]],[[],[],[],[],[]]],U:function(){var a=this.B[0],b=this.B[1],c=a[4],d=b[4],e,f,g,h=[],k=[],l,p,m,n;for(e=0;0x100>e;e++)k[(h[e]=e<<1^283*(e>>7))^e]=e;for(f=g=0;!c[f];f^=l||1,g=k[g]||1)for(m=g^g<<1^g<<2^g<<3^g<<4,m=m>>8^m&255^99,c[f]=m,d[m]=f,p=h[e=h[l=h[f]]],n=0x1010101*p^0x10001*e^0x101*l^0x1010100*f,p=0x101*h[m]^0x1010100*m,e=0;4>e;e++)a[e][f]=p=p<<24^p>>>8,b[e][m]=n=n<<24^n>>>8;for(e=
0;5>e;e++)a[e]=a[e].slice(0),b[e]=b[e].slice(0)}};
function t(a,b,c){if(4!==b.length)throw new sjcl.exception.invalid("invalid aes block size");var d=a.g[c],e=b[0]^d[0],f=b[c?3:1]^d[1],g=b[2]^d[2];b=b[c?1:3]^d[3];var h,k,l,p=d.length/4-2,m,n=4,r=[0,0,0,0];h=a.B[c];a=h[0];var q=h[1],v=h[2],z=h[3],A=h[4];for(m=0;m<p;m++)h=a[e>>>24]^q[f>>16&255]^v[g>>8&255]^z[b&255]^d[n],k=a[f>>>24]^q[g>>16&255]^v[b>>8&255]^z[e&255]^d[n+1],l=a[g>>>24]^q[b>>16&255]^v[e>>8&255]^z[f&255]^d[n+2],b=a[b>>>24]^q[e>>16&255]^v[f>>8&255]^z[g&255]^d[n+3],n+=4,e=h,f=k,g=l;for(m=
0;4>m;m++)r[c?3&-m:m]=A[e>>>24]<<24^A[f>>16&255]<<16^A[g>>8&255]<<8^A[b&255]^d[n++],h=e,e=f,f=g,g=b,b=h;return r}
...
sjcl.codec.base64={$:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",fromBits:function(a,b,c){var d="",e=0,f=sjcl.codec.base64.$,g=0,h=sjcl.bitArray.bitLength(a);c&&(f=f.substr(0,62)+"-_");for(c=0;6*d.length<h;)d+=f.charAt((g^a[c]>>>e)>>>26),6>e?(g=a[c]<<6-e,e+=26,c++):(g<<=6,e-=6);for(;d.length&3&&!b;)d+="=";return d},toBits:function(a,b){a=a.replace(/\s|=/g,"");var c=[],d,e=0,f=sjcl.codec.base64.$,g=0,h;b&&(f=f.substr(0,62)+"-_");for(d=0;d<a.length;d++){h=f.indexOf(a.charAt(d));
if(0>h)throw new sjcl.exception.invalid("this isn't base64!");26<e?(e-=26,c.push(g^h>>>e),g=h<<32-e):(e+=6,g^=h<<32-e)}e&56&&c.push(sjcl.bitArray.partial(e&56,g,1));return c}};sjcl.codec.base64url={fromBits:function(a){return sjcl.codec.base64.fromBits(a,1,1)},toBits:function(a){return sjcl.codec.base64.toBits(a,1)}};sjcl.hash.sha256=function(a){this.g[0]||this.U();a?(this.J=a.J.slice(0),this.F=a.F.slice(0),this.s=a.s):this.reset()};sjcl.hash.sha256.hash=function(a){return(new sjcl.hash.sha256).update(a).finalize()};
sjcl.hash.sha256.prototype={blockSize:512,reset:function(){this.J=this.ga.slice(0);this.F=[];this.s=0;return this},update:function(a){"string"===typeof a&&(a=sjcl.codec.utf8String.toBits(a));var b,c=this.F=sjcl.bitArray.concat(this.F,a);b=this.s;a=this.s=b+sjcl.bitArray.bitLength(a);for(b=512+b&-512;b<=a;b+=512)u(this,c.splice(0,16));return this},finalize:function(){var a,b=this.F,c=this.J,b=sjcl.bitArray.concat(b,[sjcl.bitArray.partial(1,1)]);for(a=b.length+2;a&15;a++)b.push(0);b.push(Math.floor(this.s/
4294967296));for(b.push(this.s|0);b.length;)u(this,b.splice(0,16));this.reset();return c},ga:[],g:[],U:function(){function a(a){return 0x100000000*(a-Math.floor(a))|0}var b=0,c=2,d;a:for(;64>b;c++){for(d=2;d*d<=c;d++)if(0===c%d)continue a;8>b&&(this.ga[b]=a(Math.pow(c,.5)));this.g[b]=a(Math.pow(c,1/3));b++}}};
function u(a,b){var c,d,e,f=b.slice(0),g=a.J,h=a.g,k=g[0],l=g[1],p=g[2],m=g[3],n=g[4],r=g[5],q=g[6],v=g[7];for(c=0;64>c;c++)16>c?d=f[c]:(d=f[c+1&15],e=f[c+14&15],d=f[c&15]=(d>>>7^d>>>18^d>>>3^d<<25^d<<14)+(e>>>17^e>>>19^e>>>10^e<<15^e<<13)+f[c&15]+f[c+9&15]|0),d=d+v+(n>>>6^n>>>11^n>>>25^n<<26^n<<21^n<<7)+(q^n&(r^q))+h[c],v=q,q=r,r=n,n=m+d|0,m=p,p=l,l=k,k=d+(l&p^m&(l^p))+(l>>>2^l>>>13^l>>>22^l<<30^l<<19^l<<10)|0;g[0]=g[0]+k|0;g[1]=g[1]+l|0;g[2]=g[2]+p|0;g[3]=g[3]+m|0;g[4]=g[4]+n|0;g[5]=g[5]+r|0;g[6]=
g[6]+q|0;g[7]=g[7]+v|0}
sjcl.mode.ccm={name:"ccm",K:[],listenProgress:function(a){sjcl.mode.ccm.K.push(a)},unListenProgress:function(a){a=sjcl.mode.ccm.K.indexOf(a);-1<a&&sjcl.mode.ccm.K.splice(a,1)},qa:function(a){var b=sjcl.mode.ccm.K.slice(),c;for(c=0;c<b.length;c+=1)b[c](a)},encrypt:function(a,b,c,d,e){var f,g=b.slice(0),h=sjcl.bitArray,k=h.bitLength(c)/8,l=h.bitLength(g)/8;e=e||64;d=d||[];if(7>k)throw new sjcl.exception.invalid("ccm: iv must be at least 7 bytes");for(f=2;4>f&&l>>>8*f;f++);f<15-k&&(f=15-k);c=h.clamp(c,
8*(15-f));b=sjcl.mode.ccm.ba(a,b,c,d,e,f);g=sjcl.mode.ccm.ca(a,g,c,b,e,f);return h.concat(g.data,g.tag)},decrypt:function(a,b,c,d,e){e=e||64;d=d||[];var f=sjcl.bitArray,g=f.bitLength(c)/8,h=f.bitLength(b),k=f.clamp(b,h-e),l=f.bitSlice(b,h-e),h=(h-e)/8;if(7>g)throw new sjcl.exception.invalid("ccm: iv must be at least 7 bytes");for(b=2;4>b&&h>>>8*b;b++);b<15-g&&(b=15-g);c=f.clamp(c,8*(15-b));k=sjcl.mode.ccm.ca(a,k,c,l,e,b);a=sjcl.mode.ccm.ba(a,k.data,c,d,e,b);if(!f.equal(k.tag,a))throw new sjcl.exception.corrupt("ccm: tag doesn't match");
return k.data},va:function(a,b,c,d,e,f){var g=[],h=sjcl.bitArray,k=h.X;d=[h.partial(8,(b.length?64:0)|d-2<<2|f-1)];d=h.concat(d,c);d[3]|=e;d=a.encrypt(d);if(b.length)for(c=h.bitLength(b)/8,65279>=c?g=[h.partial(16,c)]:0xffffffff>=c&&(g=h.concat([h.partial(16,65534)],[c])),g=h.concat(g,b),b=0;b<g.length;b+=4)d=a.encrypt(k(d,g.slice(b,b+4).concat([0,0,0])));return d},ba:function(a,b,c,d,e,f){var g=sjcl.bitArray,h=g.X;e/=8;if(e%2||4>e||16<e)throw new sjcl.exception.invalid("ccm: invalid tag length");
if(0xffffffff<d.length||0xffffffff<b.length)throw new sjcl.exception.bug("ccm: can't deal with 4GiB or more data");c=sjcl.mode.ccm.va(a,d,c,e,g.bitLength(b)/8,f);for(d=0;d<b.length;d+=4)c=a.encrypt(h(c,b.slice(d,d+4).concat([0,0,0])));return g.clamp(c,8*e)},ca:function(a,b,c,d,e,f){var g,h=sjcl.bitArray;g=h.X;var k=b.length,l=h.bitLength(b),p=k/50,m=p;c=h.concat([h.partial(8,f-1)],c).concat([0,0,0]).slice(0,4);d=h.bitSlice(g(d,a.encrypt(c)),0,e);if(!k)return{tag:d,data:[]};for(g=0;g<k;g+=4)g>p&&(sjcl.mode.ccm.qa(g/
k),p+=m),c[3]++,e=a.encrypt(c),b[g]^=e[0],b[g+1]^=e[1],b[g+2]^=e[2],b[g+3]^=e[3];return{tag:d,data:h.clamp(b,l)}}};sjcl.misc.hmac=function(a,b){this.fa=b=b||sjcl.hash.sha256;var c=[[],[]],d,e=b.prototype.blockSize/32;this.D=[new b,new b];a.length>e&&(a=b.hash(a));for(d=0;d<e;d++)c[0][d]=a[d]^909522486,c[1][d]=a[d]^1549556828;this.D[0].update(c[0]);this.D[1].update(c[1]);this.W=new b(this.D[0])};
sjcl.misc.hmac.prototype.encrypt=sjcl.misc.hmac.prototype.mac=function(a){if(this.la)throw new sjcl.exception.invalid("encrypt on already updated hmac called!");this.update(a);return this.digest(a)};sjcl.misc.hmac.prototype.reset=function(){this.W=new this.fa(this.D[0]);this.la=!1};sjcl.misc.hmac.prototype.update=function(a){this.la=!0;this.W.update(a)};sjcl.misc.hmac.prototype.digest=function(){var a=this.W.finalize(),a=(new this.fa(this.D[1])).update(a).finalize();this.reset();return a};
sjcl.misc.pbkdf2=function(a,b,c,d,e){c=c||1E3;if(0>d||0>c)throw sjcl.exception.invalid("invalid params to pbkdf2");"string"===typeof a&&(a=sjcl.codec.utf8String.toBits(a));"string"===typeof b&&(b=sjcl.codec.utf8String.toBits(b));e=e||sjcl.misc.hmac;a=new e(a);var f,g,h,k,l=[],p=sjcl.bitArray;for(k=1;32*l.length<(d||1);k++){e=f=a.encrypt(p.concat(b,[k]));for(g=1;g<c;g++)for(f=a.encrypt(f),h=0;h<f.length;h++)e[h]^=f[h];l=l.concat(e)}d&&(l=p.clamp(l,d));return l};
sjcl.prng=function(a){this.h=[new sjcl.hash.sha256];this.w=[0];this.V=0;this.L={};this.T=0;this.aa={};this.ia=this.j=this.A=this.sa=0;this.g=[0,0,0,0,0,0,0,0];this.m=[0,0,0,0];this.R=void 0;this.S=a;this.I=!1;this.P={progress:{},seeded:{}};this.C=this.ra=0;this.N=1;this.O=2;this.na=0x10000;this.Z=[0,48,64,96,128,192,0x100,384,512,768,1024];this.oa=3E4;this.ma=80};
sjcl.prng.prototype={randomWords:function(a,b){var c=[],d;d=this.isReady(b);var e;if(d===this.C)throw new sjcl.exception.notReady("generator isn't seeded");if(d&this.O){d=!(d&this.N);e=[];var f=0,g;this.ia=e[0]=(new Date).valueOf()+this.oa;for(g=0;16>g;g++)e.push(0x100000000*Math.random()|0);for(g=0;g<this.h.length&&(e=e.concat(this.h[g].finalize()),f+=this.w[g],this.w[g]=0,d||!(this.V&1<<g));g++);this.V>=1<<this.h.length&&(this.h.push(new sjcl.hash.sha256),this.w.push(0));this.j-=f;f>this.A&&(this.A=
f);this.V++;this.g=sjcl.hash.sha256.hash(this.g.concat(e));this.R=new sjcl.cipher.aes(this.g);for(d=0;4>d&&(this.m[d]=this.m[d]+1|0,!this.m[d]);d++);}for(d=0;d<a;d+=4)0===(d+1)%this.na&&w(this),e=x(this),c.push(e[0],e[1],e[2],e[3]);w(this);return c.slice(0,a)},setDefaultParanoia:function(a,b){if(0===a&&"Setting paranoia=0 will ruin your security; use it only for testing"!==b)throw"Setting paranoia=0 will ruin your security; use it only for testing";this.S=a},addEntropy:function(a,b,c){c=c||"user";
var d,e,f=(new Date).valueOf(),g=this.L[c],h=this.isReady(),k=0;d=this.aa[c];void 0===d&&(d=this.aa[c]=this.sa++);void 0===g&&(g=this.L[c]=0);this.L[c]=(this.L[c]+1)%this.h.length;switch(typeof a){case "number":void 0===b&&(b=1);this.h[g].update([d,this.T++,1,b,f,1,a|0]);break;case "object":c=Object.prototype.toString.call(a);if("[object Uint32Array]"===c){e=[];for(c=0;c<a.length;c++)e.push(a[c]);a=e}else for("[object Array]"!==c&&(k=1),c=0;c<a.length&&!k;c++)"number"!==typeof a[c]&&(k=1);if(!k){if(void 0===
b)for(c=b=0;c<a.length;c++)for(e=a[c];0<e;)b++,e=e>>>1;this.h[g].update([d,this.T++,2,b,f,a.length].concat(a))}break;case "string":void 0===b&&(b=a.length);this.h[g].update([d,this.T++,3,b,f,a.length]);this.h[g].update(a);break;default:k=1}if(k)throw new sjcl.exception.bug("random: addEntropy only supports number, array of numbers or string");this.w[g]+=b;this.j+=b;h===this.C&&(this.isReady()!==this.C&&y("seeded",Math.max(this.A,this.j)),y("progress",this.getProgress()))},isReady:function(a){a=this.Z[void 0!==
a?a:this.S];return this.A&&this.A>=a?this.w[0]>this.ma&&(new Date).valueOf()>this.ia?this.O|this.N:this.N:this.j>=a?this.O|this.C:this.C},getProgress:function(a){a=this.Z[a?a:this.S];return this.A>=a?1:this.j>a?1:this.j/a},startCollectors:function(){if(!this.I){this.c={loadTimeCollector:B(this,this.ua),mouseCollector:B(this,this.wa),keyboardCollector:B(this,this.ta),accelerometerCollector:B(this,this.pa),touchCollector:B(this,this.ya)};if(window.addEventListener)window.addEventListener("load",this.c.loadTimeCollector,
...
this.I=!0}},stopCollectors:function(){this.I&&(window.removeEventListener?(window.removeEventListener("load",this.c.loadTimeCollector,!1),window.removeEventListener("mousemove",this.c.mouseCollector,!1),window.removeEventListener("keypress",this.c.keyboardCollector,!1),window.removeEventListener("devicemotion",this.c.accelerometerCollector,!1),window.removeEventListener("touchmove",this.c.touchCollector,!1)):document.detachEvent&&(document.detachEvent("onload",this.c.loadTimeCollector),document.detachEvent("onmousemove",
this.c.mouseCollector),document.detachEvent("keypress",this.c.keyboardCollector)),this.I=!1)},addEventListener:function(a,b){this.P[a][this.ra++]=b},removeEventListener:function(a,b){var c,d,e=this.P[a],f=[];for(d in e)e.hasOwnProperty(d)&&e[d]===b&&f.push(d);for(c=0;c<f.length;c++)d=f[c],delete e[d]},ta:function(){C(1)},wa:function(a){var b,c;try{b=a.x||a.clientX||a.offsetX||0,c=a.y||a.clientY||a.offsetY||0}catch(d){c=b=0}0!=b&&0!=c&&sjcl.random.addEntropy([b,c],2,"mouse");C(0)},ya:function(a){a=
a.touches[0]||a.changedTouches[0];sjcl.random.addEntropy([a.pageX||a.clientX,a.pageY||a.clientY],1,"touch");C(0)},ua:function(){C(2)},pa:function(a){a=a.accelerationIncludingGravity.x||a.accelerationIncludingGravity.y||a.accelerationIncludingGravity.z;if(window.orientation){var b=window.orientation;"number"===typeof b&&sjcl.random.addEntropy(b,1,"accelerometer")}a&&sjcl.random.addEntropy(a,2,"accelerometer");C(0)}};
function y(a,b){var c,d=sjcl.random.P[a],e=[];for(c in d)d.hasOwnProperty(c)&&e.push(d[c]);for(c=0;c<e.length;c++)e[c](b)}function C(a){"undefined"!==typeof window&&window.performance&&"function"===typeof window.performance.now?sjcl.random.addEntropy(window.performance.now(),a,"loadtime"):sjcl.random.addEntropy((new Date).valueOf(),a,"loadtime")}function w(a){a.g=x(a).concat(x(a));a.R=new sjcl.cipher.aes(a.g)}
function x(a){for(var b=0;4>b&&(a.m[b]=a.m[b]+1|0,!a.m[b]);b++);return a.R.encrypt(a.m)}function B(a,b){return function(){b.apply(a,arguments)}}sjcl.random=new sjcl.prng(6);
a:try{var D,E,F;if("undefined"!==typeof window&&"undefined"!==typeof Uint32Array){F=new Uint32Array(32);if(window.crypto&&window.crypto.getRandomValues)window.crypto.getRandomValues(F);else if(window.msCrypto&&window.msCrypto.getRandomValues)window.msCrypto.getRandomValues(F);else break a;sjcl.random.addEntropy(F,1024,"crypto['getRandomValues']")}else{var G;if(G="undefined"!==typeof module&&module.exports){var H;try{H=require("crypto")}catch(a){H=null}G=E=H}if(G&&E.randomBytes)D=E.randomBytes(128),
D=new Uint32Array((new Uint8Array(D)).buffer),sjcl.random.addEntropy(D,1024,"crypto['randomBytes']");else{for(var I=[],J=0;32>J;J++)I.push((new Date).valueOf()*(1E3*Math.random()|0));sjcl.random.addEntropy(I,1024,"loadtime")}}}catch(a){"undefined"!==typeof window&&window.console&&(console.log("There was an error collecting entropy from the browser:"),console.log(a))}
sjcl.json={defaults:{v:1,iter:1E3,ks:128,ts:64,mode:"ccm",adata:"",cipher:"aes"},ea:function(a,b,c,d){c=c||{};d=d||{};var e=sjcl.json,f=e.l({iv:sjcl.random.randomWords(4,0)},e.defaults),g;e.l(f,c);c=f.adata;"string"===typeof f.salt&&(f.salt=sjcl.codec.base64.toBits(f.salt));"string"===typeof f.iv&&(f.iv=sjcl.codec.base64.toBits(f.iv));if(!sjcl.mode[f.mode]||!sjcl.cipher[f.cipher]||"string"===typeof a&&100>=f.iter||64!==f.ts&&96!==f.ts&&128!==f.ts||128!==f.ks&&192!==f.ks&&0x100!==f.ks||2>f.iv.length||
...
e.subM(b);return e}a=(new sjcl.bn(a)).normalize().trim();b=new sjcl.bn(b);var e,f,g=this.radix,h=new this.f(1);e=this.copy();var k,l,p;p=a.bitLength();k=new sjcl.bn({limbs:b.copy().normalize().trim().limbs.map(function(){return 0})});for(l=this.radix;0<l;l--)if(1==(b.limbs[b.limbs.length-1]>>l&1)){k.limbs[k.limbs.length-1]=1<<l;break}if(0==p)return this;p=18>p?1:48>p?3:144>p?4:768>p?5:6;var m=k.copy(),n=b.copy();f=new sjcl.bn(1);for(var r=new sjcl.bn(0),q=k.copy();q.greaterEquals(1);)q.halveM(),0==
(f.limbs[0]&1)?(f.halveM(),r.halveM()):(f.addM(n),f.halveM(),r.halveM(),r.addM(m));f=f.normalize();r=r.normalize();m.doubleM();n=m.mulmod(m,b);if(!m.mul(f).sub(b.mul(r)).equals(1))return!1;e=d(e,n);h=d(h,n);m={};f=(1<<p-1)-1;m[1]=e.copy();m[2]=d(e,e);for(e=1;e<=f;e++)m[2*e+1]=d(m[2*e-1],m[2]);for(e=a.bitLength()-1;0<=e;)if(0==c(a,e))h=d(h,h),--e;else{for(n=e-p+1;0==c(a,n);)n++;q=0;for(f=n;f<=e;f++)q+=c(a,f)<<f-n,h=d(h,h);h=d(h,m[q]);e=n-1}return d(h,1)},trim:function(){var a=this.limbs,b;do b=a.pop();
while(a.length&&0===b);a.push(b);return this},reduce:function(){return this},fullReduce:function(){return this.normalize()},normalize:function(){var a=0,b,c=this.placeVal,d=this.ipv,e,f=this.limbs,g=f.length,h=this.radixMask;for(b=0;b<g||0!==a&&-1!==a;b++)a=(f[b]||0)+a,e=f[b]=a&h,a=(a-e)*d;for(-1===a&&(f[b-1]-=c);0<f.length&&0===f[f.length-1];)f.pop();return this},cnormalize:function(){var a=0,b,c=this.ipv,d,e=this.limbs,f=e.length,g=this.radixMask;for(b=0;b<f-1;b++)a=e[b]+a,d=e[b]=a&g,a=(a-d)*c;
e[b]+=a;return this},toBits:function(a){this.fullReduce();a=a||this.exponent||this.bitLength();var b=Math.floor((a-1)/24),c=sjcl.bitArray,d=[c.partial((a+7&-8)%this.radix||this.radix,this.getLimb(b))];for(b--;0<=b;b--)d=c.concat(d,[c.partial(Math.min(this.radix,a),this.getLimb(b))]),a-=this.radix;return d},bitLength:function(){this.fullReduce();for(var a=this.radix*(this.limbs.length-1),b=this.limbs[this.limbs.length-1];b;b>>>=1)a++;return a+7&-8}};
...
b[e][1]*Math.pow(.5,a-b[e][0]+d.fullOffset[e]*d.radix),d.modulus.addM(new sjcl.bn(Math.pow(2,b[e][0])*b[e][1])),d.minOffset=Math.min(d.minOffset,-d.offset[e]);d.f=c;d.modulus.cnormalize();d.reduce=function(){var a,b,c,d=this.modOffset,e=this.limbs,f=this.offset,n=this.offset.length,r=this.factor,q;for(a=this.minOffset;e.length>d;){c=e.pop();q=e.length;for(b=0;b<n;b++)e[q+f[b]]-=r[b]*c;a--;a||(e.push(0),this.cnormalize(),a=this.minOffset)}this.cnormalize();return this};d.ka=-1===d.fullMask?d.reduce:
...
return this};d.inverse=function(){return this.power(this.modulus.sub(2))};c.fromBits=sjcl.bn.fromBits;return c};var K=sjcl.bn.pseudoMersennePrime;
sjcl.bn.prime={p127:K(127,[[0,-1]]),p25519:K(255,[[0,-19]]),p192k:K(192,[[32,-1],[12,-1],[8,-1],[7,-1],[6,-1],[3,-1],[0,-1]]),p224k:K(224,[[32,-1],[12,-1],[11,-1],[9,-1],[7,-1],[4,-1],[1,-1],[0,-1]]),p256k:K(0x100,[[32,-1],[9,-1],[8,-1],[7,-1],[6,-1],[4,-1],[0,-1]]),p192:K(192,[[0,-1],[64,-1]]),p224:K(224,[[0,1],[96,-1]]),p256:K(0x100,[[0,-1],[96,1],[192,1],[224,-1]]),p384:K(384,[[0,-1],[32,1],[96,-1],[128,-1]]),p521:K(521,[[0,-1]])};
...
sjcl.ecc.basicKey={publicKey:function(a,b){this.i=a;this.o=a.r.bitLength();b instanceof Array?this.u=a.fromBits(b):this.u=b;this.get=function(){var a=this.u.toBits(),b=sjcl.bitArray.bitLength(a),e=sjcl.bitArray.bitSlice(a,0,b/2),a=sjcl.bitArray.bitSlice(a,b/2);return{x:e,y:a}}},secretKey:function(a,b){this.i=a;this.o=a.r.bitLength();this.H=b;this.get=function(){return this.H.toBits()}}};
sjcl.ecc.basicKey.generateKeys=function(a){return function(b,c,d){b=b||0x100;if("number"===typeof b&&(b=sjcl.ecc.curves["c"+b],void 0===b))throw new sjcl.exception.invalid("no such curve");d=d||sjcl.bn.random(b.r,c);c=b.G.mult(d);return{pub:new sjcl.ecc[a].publicKey(b,c),sec:new sjcl.ecc[a].secretKey(b,d)}}};
sjcl.ecc.elGamal={generateKeys:sjcl.ecc.basicKey.generateKeys("elGamal"),publicKey:function(a,b){sjcl.ecc.basicKey.publicKey.apply(this,arguments)},secretKey:function(a,b){sjcl.ecc.basicKey.secretKey.apply(this,arguments)}};sjcl.ecc.elGamal.publicKey.prototype={kem:function(a){a=sjcl.bn.random(this.i.r,a);var b=this.i.G.mult(a).toBits();return{key:sjcl.hash.sha256.hash(this.u.mult(a).toBits()),tag:b}}};
sjcl.ecc.elGamal.secretKey.prototype={unkem:function(a){return sjcl.hash.sha256.hash(this.i.fromBits(a).mult(this.H).toBits())},dh:function(a){return sjcl.hash.sha256.hash(a.u.mult(this.H).toBits())},dhJavaEc:function(a){return a.u.mult(this.H).x.toBits()}};sjcl.ecc.ecdsa={generateKeys:sjcl.ecc.basicKey.generateKeys("ecdsa")};sjcl.ecc.ecdsa.publicKey=function(a,b){sjcl.ecc.basicKey.publicKey.apply(this,arguments)};
sjcl.ecc.ecdsa.publicKey.prototype={verify:function(a,b,c){sjcl.bitArray.bitLength(a)>this.o&&(a=sjcl.bitArray.clamp(a,this.o));var d=sjcl.bitArray,e=this.i.r,f=this.o,g=sjcl.bn.fromBits(d.bitSlice(b,0,f)),d=sjcl.bn.fromBits(d.bitSlice(b,f,2*f)),h=c?d:d.inverseMod(e),f=sjcl.bn.fromBits(a).mul(h).mod(e),h=g.mul(h).mod(e),f=this.i.G.mult2(f,h,this.u).x;if(g.equals(0)||d.equals(0)||g.greaterEquals(e)||d.greaterEquals(e)||!f.equals(g)){if(void 0===c)return this.verify(a,b,!0);throw new sjcl.exception.corrupt("signature didn't check out");
}return!0}};sjcl.ecc.ecdsa.secretKey=function(a,b){sjcl.ecc.basicKey.secretKey.apply(this,arguments)};sjcl.ecc.ecdsa.secretKey.prototype={sign:function(a,b,c,d){sjcl.bitArray.bitLength(a)>this.o&&(a=sjcl.bitArray.clamp(a,this.o));var e=this.i.r,f=e.bitLength();d=d||sjcl.bn.random(e.sub(1),b).add(1);b=this.i.G.mult(d).x.mod(e);a=sjcl.bn.fromBits(a).add(b.mul(this.H));c=c?a.inverseMod(e).mul(d).mod(e):a.mul(d.inverseMod(e)).mod(e);return sjcl.bitArray.concat(b.toBits(f),c.toBits(f))}};
var L={},M=L.ENC_DEC={},N=L.SIG_VER={},P=O("elGamal"),Q=O("ecdsa"),S=R();L.sjcl=sjcl;L.generate=function(a,b){b||(b=192);var c,d,e;if(a===M)d="enc",e="dec",c=P.generate(b);else if(a===N)d="ver",e="sig",c=Q.generate(b);else throw"eccjs: generate: Unknown type";var f={},g;g=c.pub;var h=g.get();g=g.M+sjcl.codec.hex.fromBits(h.x)+sjcl.codec.hex.fromBits(h.y);f[d]=g;c=c.sec;c=c.M+sjcl.codec.hex.fromBits(c.get());f[e]=c;return f};var T={enc:{},dec:{},sig:{},ver:{}};
L.encrypt=function(a,b){var c=T.enc[a];c||(c=T.enc[a]=P.importPublic(a).kem(),c.tagHex=sjcl.codec.hex.fromBits(c.tag));var d=sjcl.json.ea(c.key,b);d.tag=c.tagHex;return JSON.stringify(d)};L.decrypt=function(a,b){var c=JSON.parse(b),d=T.dec[a];d||(d=T.dec[a]=P.importSecret(a),d.Y={});var e=d.Y[c.tag];e||(e=d.Y[c.tag]=d.unkem(sjcl.codec.hex.toBits(c.tag)));return sjcl.json.da(e,c)};L.sign=function(a,b,c){var d=T.sig[a];d||(d=T.sig[a]=Q.importSecret(a));!1!==c&&(b=S.hash(b));return d.sign(b)};
L.verify=function(a,b,c,d){var e=T.ver[a];e||(e=T.ver[a]=Q.importPublic(a));!1!==d&&(c=S.hash(c));try{return e.verify(c,b)}catch(f){return!1}};function O(a){var b=sjcl.ecc[a];if(!b)throw Error("Missing ECC algorithm: "+a);return{generate:function(a){var d=b.generateKeys(a,1);d.pub.M=a;d.sec.M=a;return d},importPublic:function(a){a=U(a);return new b.publicKey(a.curve,sjcl.codec.hex.toBits(a.hex))},importSecret:function(a){a=U(a);return new b.secretKey(a.curve,new sjcl.bn(a.hex))}}}
function U(a){return{curve:sjcl.ecc.curves["c"+a.substr(0,3)],hex:a.substr(3)}}function R(){var a=sjcl.hash.sha256;if(!a)throw Error("Missing hash algorithm: sha256");return{hash:function(b){return a.hash(b)}}}"undefined"!==typeof module&&module.exports?module.exports=L:"undefined"!==typeof window?window.ecc=L:this.ecc=L;
