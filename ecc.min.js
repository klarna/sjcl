...
else break a;sjcl.random.addEntropy(F,1024,"crypto['getRandomValues']")}else{for(var I=[],J=0;32>J;J++)I.push((new Date).valueOf()*(1E3*Math.random()|0));sjcl.random.addEntropy(I,1024,"loadtime")}}catch(a){"undefined"!==typeof window&&window.console&&(console.log("There was an error collecting entropy from the browser:"),console.log(a))}
