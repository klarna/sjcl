...
if(0>h)throw new sjcl.exception.invalid("this isn't base64!");26<e?(e-=26,c.push(g^h>>>e),g=h<<32-e):(e+=6,g^=h<<32-e)}e&56&&c.push(sjcl.bitArray.partial(e&56,g,1));return c}};sjcl.codec.base64url={fromBits:function(a){return sjcl.codec.base64.fromBits(a,1,1)},toBits:function(a){return sjcl.codec.base64.toBits(a,1)}};sjcl.hash.sha256=function(a){this.g[0]||this.U();a?(this.J=a.J.slice(0),this.F=a.F.slice(0),this.u=a.u):this.reset()};sjcl.hash.sha256.hash=function(a){return(new sjcl.hash.sha256).update(a).finalize()};
sjcl.hash.sha256.prototype={blockSize:512,reset:function(){this.J=this.ga.slice(0);this.F=[];this.u=0;return this},update:function(a){"string"===typeof a&&(a=sjcl.codec.utf8String.toBits(a));var b,c=this.F=sjcl.bitArray.concat(this.F,a);b=this.u;a=this.u=b+sjcl.bitArray.bitLength(a);for(b=512+b&-512;b<=a;b+=512)u(this,c.splice(0,16));return this},finalize:function(){var a,b=this.F,c=this.J,b=sjcl.bitArray.concat(b,[sjcl.bitArray.partial(1,1)]);for(a=b.length+2;a&15;a++)b.push(0);b.push(Math.floor(this.u/
4294967296));for(b.push(this.u|0);b.length;)u(this,b.splice(0,16));this.reset();return c},ga:[],g:[],U:function(){function a(a){return 0x100000000*(a-Math.floor(a))|0}var b=0,c=2,d;a:for(;64>b;c++){for(d=2;d*d<=c;d++)if(0===c%d)continue a;8>b&&(this.ga[b]=a(Math.pow(c,.5)));this.g[b]=a(Math.pow(c,1/3));b++}}};
...
sjcl.ecc.ecdsa.secretKey.prototype={sign:function(a,b,c,d){sjcl.bitArray.bitLength(a)>this.s&&(a=sjcl.bitArray.clamp(a,this.s));var e=this.i.r,f=e.bitLength();d=d||sjcl.bn.random(e.sub(1),b).add(1);b=this.i.G.mult(d).x.mod(e);a=sjcl.bn.fromBits(a).add(b.mul(this.H));c=c?a.inverseMod(e).mul(d).mod(e):a.mul(d.inverseMod(e)).mod(e);return sjcl.bitArray.concat(b.toBits(f),c.toBits(f))},getType:function(){return"ecdsa"}};var L={},M=L.ENC_DEC={},N=L.SIG_VER={},P=O("elGamal"),Q=O("ecdsa"),S=R();L.sjcl=sjcl;
L.generate=function(a,b){b||(b=192);var c,d,e;if(a===M)d="enc",e="dec",c=P.generate(b);else if(a===N)d="ver",e="sig",c=Q.generate(b);else throw"eccjs: generate: Unknown type";var f={},g;g=c.pub;var h=g.get();g=g.M+sjcl.codec.hex.fromBits(h.x)+sjcl.codec.hex.fromBits(h.y);f[d]=g;c=c.sec;c=c.M+sjcl.codec.hex.fromBits(c.get());f[e]=c;return f};var T={enc:{},dec:{},sig:{},ver:{}};
L.encrypt=function(a,b){try{var c=T.enc[a];c||(c=T.enc[a]=P.importPublic(a).kem(),c.tagHex=sjcl.codec.hex.fromBits(c.tag));var d=sjcl.json.ea(c.key,b);d.tag=c.tagHex;return JSON.stringify(d)}catch(e){return"undefined"!==typeof console&&console.error&&console.error(e),b}};
L.decrypt=function(a,b){var c=JSON.parse(b);try{var d=T.dec[a];d||(d=T.dec[a]=P.importSecret(a),d.Y={});var e=d.Y[c.tag];e||(e=d.Y[c.tag]=d.unkem(sjcl.codec.hex.toBits(c.tag)));return sjcl.json.da(e,c)}catch(f){return"undefined"!==typeof console&&console.error&&console.error(f),b}};L.sign=function(a,b,c){var d=T.sig[a];d||(d=T.sig[a]=Q.importSecret(a));!1!==c&&(b=S.hash(b));return d.sign(b)};
